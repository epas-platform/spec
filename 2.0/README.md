# EPAS v2.0 Specification — Document Set

Enterprise Multi-Platform Architecture Specification, version 1.4.

Version 1.4 is published as a **document set**: one monolithic scaffold file (`Enterprise_MultiPlatform_Architecture_Scaffold_v2.0.md`) that indexes into a collection of self-contained normative specifications in this directory. Each specification here is authoritative for its topic; the scaffold provides narrative and cross-references.
...
| # | Document | Status |
|---|----------|--------|
| 00 | [v2.0 Overview](./00-overview.md) | Draft |
...
| 08 | [Event-Driven Architecture (v2.0 revision)](./08-event-driven-architecture.md) | Draft |
...
Monolithic scaffold: [Enterprise_MultiPlatform_Architecture_Scaffold_v2.0.md](../Enterprise_MultiPlatform_Architecture_Scaffold_v2.0.md)
...
## v2.0 Naming and Positioning

v2.0 is the **AI-first and SDK-first** revision of EPAS. It changes what the platform is *for*, not merely what it is *made of*.

Where v1.3 asked "how do we build a multi-tenant enterprise platform," v2.0 asks "how do we build a platform whose primary consumers are AI agents, and whose primary safety property is provable consent."
...
Everything else in v2.0 — machine-readable documentation, agentic governance, edge nodes, Flutter clients — depends on these two tentpoles.
...
- **v2.0.0** — In progress, document set, AI-first and SDK-first, contract-based trust

The v1.3 scaffold file remains in the repository root until v2.0 is complete. Upon completion, the v2.0 monolithic file supersedes it; the v1.3 file moves to `1.3 Archive/`.
...
- [v1.4 Update Plan](../1.4%20Planning/epas-v1.4-update-plan.md) — the original amendment plan authored under the v1.4 working title; informed this document set before the SemVer correction to v2.0
- [v1.4 Edge/NATS/Flutter Addendum](../1.4%20Planning/epas-v1.4-addendum-edge-nats-flutter-fsm.md) — subsumed by document 07; original filename preserved as historical artifact
- [v1.3 Scaffold](../Enterprise_MultiPlatform_Architecture_Scaffold.md) — the prior monolithic spec; v2.0 supersedes on completion
- [ADR 001 — SemVer correction v1.4 → v2.0](../docs/adr/001-semver-v2.md) — decision record for the version label correction
